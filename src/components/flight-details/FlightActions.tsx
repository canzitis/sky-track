      ...
      <div className="grid grid-cols-4 gap-1">
        <button
          ...
          className="flex flex-col items-center gap-2 bg-card px-mini-element py-mini-element rounded-tl-2xl rounded-bl-2xl
					transition-colors hover:bg-neutral-700 px-3 py-2"
        >
        ...
        <button
          onClick={onFollow}
          className="flex flex-col items-center gap-2 bg-card px-mini-element py-mini-element transition-colors hover:bg-neutral-700 px-3 py-2"
        >
        ...
        <button
          onClick={onMore}
          className="flex flex-col items-center gap-2 bg-card px-mini-element py-mini-element rounded-tr-2xl rounded-br-2xl transition-colors hover:bg-neutral-700 px-3 py-2"
        >
